<template>
    <div class="seller-products m-xl">
        ...
        <b-button type="is-primary" class="m-b-lg" @click="showCreateModal"
        ...
        <div>
            <b-table :bordered="true" :data="products">
                <template slot-scope="props">
                    ...
                    >
                    <b-table-column field="description" label="Descriere">{{
                    ...
                    >
                    <b-table-column width="80" field="u_m" label="U.M.">{{
        ...
        <b-modal
            :active.sync="createModal.visible"
            has-modal-card
            :can-cancel="true"
        >
            <product-create
        ...
        <b-modal
            :active.sync="deleteModal.visible"
            has-modal-card
            :can-cancel="true"
        >
            <div class="card p-md modal-content">
                ...
                <div class="flex-align">
                    <b-button type="is-primary" @click="closeDeleteModal"
                        >Anulează</b-button
                    >
                    <b-button type="is-danger" @click.prevent="deleteProduct"
                        >Confirmă</b-button
                    >
                </div>
            </div>
